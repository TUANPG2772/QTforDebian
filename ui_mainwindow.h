...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        btnOpenDoor->setGeometry(QRect(650, 300, 80, 25));
        btnCloseDoor = new QPushButton(centralwidget);
        btnCloseDoor->setObjectName(QString::fromUtf8("btnCloseDoor"));
        btnCloseDoor->setGeometry(QRect(750, 300, 80, 25));
        graphicsView = new QGraphicsView(centralwidget);
        graphicsView->setObjectName(QString::fromUtf8("graphicsView"));
        graphicsView->setGeometry(QRect(350, 210, 271, 192));
        textEdit = new QTextEdit(centralwidget);
        textEdit->setObjectName(QString::fromUtf8("textEdit"));
        textEdit->setGeometry(QRect(630, 210, 281, 70));
